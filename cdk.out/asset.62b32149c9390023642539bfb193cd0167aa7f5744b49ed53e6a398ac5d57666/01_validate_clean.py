...
# -------------------------
# NORMALIZE TYPES (MODIFIED ✅ — ONLY REQUIRED COLS)
# -------------------------
df = (
...
# -------------------------
# Validation rules (SIMPLIFIED & SAFE)
# -------------------------
...
# -------------------------
# Fail if quality breach (UNCHANGED)
# -------------------------
